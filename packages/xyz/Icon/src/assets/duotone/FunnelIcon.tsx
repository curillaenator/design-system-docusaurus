...
const FunnelIcon = (props: IconProps, ref: Ref<SVGSVGElement>) => (
  ...
  >
    <path
      opacity={0.4}
      d='M12.0751 18.2477V27.0538C12.0751 27.3745 12.2366 27.6766 12.501 27.8497C12.6521 27.9495 12.8266 28 13.0011 28C13.1327 28 13.2642 27.9721 13.3866 27.9162L18.6745 25.4515C19.0053 25.2984 19.2176 24.9617 19.2176 24.5904V18.2477H12.0751Z'
      fill='currentColor'
    />
    <path
