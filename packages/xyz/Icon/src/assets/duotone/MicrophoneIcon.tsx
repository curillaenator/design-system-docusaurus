...
const MicrophoneIcon = (props: IconProps, ref: Ref<SVGSVGElement>) => (
  ...
  >
    <path
      d='M15.7894 19.8605H16.2102C19.0931 19.8605 21.432 17.5519 21.432 14.7049V9.15672C21.432 6.30744 19.0931 4 16.2102 4H15.7894C12.9065 4 10.5676 6.30744 10.5676 9.15672V14.7049C10.5676 17.5519 12.9065 19.8605 15.7894 19.8605Z'
      fill='currentColor'
    />
    <path
      opacity={0.4}
