...
const ListIcon = (props: IconProps, ref: Ref<SVGSVGElement>) => (
  ...
  >
    ...
    />
    <path
      d='M12.2533 9.38764C12.2533 11.6276 10.4066 13.4432 8.12664 13.4432C5.84799 13.4432 4 11.6276 4 9.38764C4 7.14895 5.84799 5.33337 8.12664 5.33337C10.4066 5.33337 12.2533 7.14895 12.2533 9.38764Z'
      fill='currentColor'
    />
  </svg>
);
