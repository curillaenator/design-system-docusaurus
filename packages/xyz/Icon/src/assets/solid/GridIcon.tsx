...
const GridIcon = (props: IconProps, ref: Ref<SVGSVGElement>) => (
  ...
  >
    <path
      d='M20.8906 4H24.9538C26.6365 4 28 5.37503 28 7.07196V11.1694C28 12.8664 26.6365 14.2414 24.9538 14.2414H20.8906C19.2079 14.2414 17.8444 12.8664 17.8444 11.1694V7.07196C17.8444 5.37503 19.2079 4 20.8906 4Z'
      fill='currentColor'
    />
    <path
