...
const LockOpenIcon = (props: IconProps, ref: Ref<SVGSVGElement>) => (
  ...
  >
    ...
    <path
      fillRule='evenodd'
      clipRule='evenodd'
      d='M10.9225 12.0533H21.0774C23.9064 12.0533 26.2 14.2968 26.2 17.0639V22.9894C26.2 25.7565 23.9064 28 21.0774 28H10.9225C8.09362 28 5.79999 25.7565 5.79999 22.9894V17.0639C5.79999 14.2968 8.09362 12.0533 10.9225 12.0533ZM15.9939 22.3942C16.5914 22.3942 17.0669 21.929 17.0669 21.3446V18.6967C17.0669 18.1242 16.5914 17.6591 15.9939 17.6591C15.4086 17.6591 14.933 18.1242 14.933 18.6967V21.3446C14.933 21.929 15.4086 22.3942 15.9939 22.3942Z'
      fill='currentColor'
    />
  </svg>
);
